...
class AttendanceCorrectionController extends Controller
{
    ...
    {
        $user = Auth::user();
        $query = AttendanceCorrection::with(['attendance.user', 'restCorrections']);
    ...
    {
        $correction = AttendanceCorrection::with('restCorrections')->findOrFail($attendance_correct_request_id);
